...
export function TopNavbar() {
  ...
  return (
    <header className="sticky top-0 h-16 border-b border-border/20 bg-background/95 backdrop-blur-sm flex items-center justify-between px-4 md:px-6 z-40">
      {/* Logo - visible on mobile */}
      <div className="md:hidden flex items-center gap-2">
        <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
          <span className="text-white font-bold text-sm">AI</span>
        </div>
        <span className="font-semibold text-sm text-foreground">Validator</span>
      </div>
      ...
      <div className="hidden md:block relative max-w-sm w-full">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="w-full h-10 pl-10 pr-4 rounded-lg bg-muted/50 border border-border/20 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-transparent transition-all duration-200"
        />
      </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={toggleTheme}
          className="w-10 h-10 rounded-lg flex items-center justify-center hover:bg-muted/50 text-muted-foreground hover:text-foreground transition-colors duration-200"
        >
          {theme === "dark" ? (
        ...
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="relative w-10 h-10 rounded-lg flex items-center justify-center hover:bg-muted/50 text-muted-foreground hover:text-foreground transition-colors duration-200"
        >
